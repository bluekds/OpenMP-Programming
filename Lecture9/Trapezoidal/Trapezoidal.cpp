...
enum Algorithm {
	Serial, Parallel_NoSync, Parallel, Parallel_offset, END
};

double Trapezodial_Serial(double a, double b, int n, double h);
double Trapezodial_Parallel_NoSync(double a, double b, int n, double h);
...
int main(void)
{
	...
	timer.setTimerName(Algorithm::Parallel_NoSync, (char*)"Parallel algorithm w/o Sync.");
	...
	RUN_TEST(Parallel_NoSync, a, b, n, h);
